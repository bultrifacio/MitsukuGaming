...
@WebServlet(name="AdminFormServlet", urlPatterns={"/AdminFormServlet"})
...
public class AdminFormServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Users c : lista) {
                if (request.getParameter("name").equals(c.getName())){
                    out.println("<form action=\"ModifyUserFormServlet\">");
                    ...
                    out.println("<input type=\"text\" name=\"email\" value=\"" + c.getEmail()
                        + "\"><br>");
                    out.println("User pass:<br>");
                    out.println("<input type=\"text\" name=\"password\" value=\"" + c.getPassword()
                        + "\"><br>");
                    out.println("<input type=\"submit\" name = \"bt\" value=\"Submit\">");
                    out.println("</fieldset>");
                    out.println("</form>");
                }
            }
